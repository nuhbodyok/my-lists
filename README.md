# Awesome AI System & Jailbreak Prompts

Curated list of system‑prompt repos, jailbreaks, GPTs‑focused catalogs, and prompt‑engineering toolkits.  
All links are GitHub repositories I actually reach for when designing, studying, or red‑teaming system prompts and AI assistants.
...
- [dukeluo/awesome‑awesome‑prompts](https://github.com/dukeluo/awesome-awesome-prompts) – Meta‑list of “awesome‑prompt” lists.  
- [elifuzz/awesome‑system‑prompts](https://github.com/elifuzz/awesome-system-prompts) – Minimalist system‑prompt examples.  
- [manuelslemos/awesome‑llm‑system‑prompts](https://github.com/manuelslemos/awesome-llm-system-prompts) – LLM‑focused system‑prompt collection.  
- [abilzerian/LLM‑Prompt‑Library](https://github.com/abilzerian/LLM-Prompt-Library) – LLM‑focused prompt library.  
- [danielrosehill/System‑Prompt‑Library](https://github.com/danielrosehill/System-Prompt-Library) – System‑prompt‑style library.  
- [guy915/System‑Prompts](https://github.com/guy915/System-Prompts) – Simple system‑prompt examples.  
- [davidegat/happy‑prompts](https://github.com/davidegat/happy-prompts) – Playful‑style prompt collection.
...
- [Piebald‑AI/claude‑code‑system‑prompts](https://github.com/Piebald-AI/claude-code-system-prompts) – Claude‑code‑assistant prompts.  
- [Leonxlnx/claude‑code‑system‑prompts](https://github.com/Leonxlnx/claude-code-system-prompts) – Claude‑code‑assistant‑focused system prompts.  
- [langgptai/awesome‑llama‑prompts](https://github.com/langgptai/awesome-llama-prompts) – Llama‑focused prompts.  
- [mustvlad/ChatGPT‑System‑Prompts](https://github.com/mustvlad/ChatGPT-System-Prompts) – ChatGPT‑system‑prompt examples.  
- [edoardoavenia/chatgpt‑system‑prompts](https://github.com/edoardoavenia/chatgpt-system-prompts) – Another ChatGPT‑system‑prompt set.  
- [LouisShark/chatgpt_system_prompt](https://github.com/LouisShark/chatgpt_system_prompt) – ChatGPT‑system‑prompt style repo.  
- [kesslernity/awesome‑microsoft‑copilot‑prompts](https://github.com/kesslernity/awesome-microsoft-copilot-prompts) – Microsoft Copilot‑focused prompts.  
- [labac‑dev/cursor‑system‑prompts](https://github.com/labac-dev/cursor-system-prompts) – Cursor‑focused system prompts.  
...
- [B3o/GPTS‑Prompt‑Collection](https://github.com/B3o/GPTS-Prompt-Collection) – GPTs‑prompt collection.  
- [f/prompts.chat](https://github.com/f/prompts.chat) – Prompts and chat‑style examples.  
- [friuns2/Awesome‑GPTs‑Big‑List](https://github.com/friuns2/Awesome-GPTs-Big-List) – Large GPTs‑focused list.  
- [friuns2/BlackFriday‑GPTs‑Prompts](https://github.com/friuns2/BlackFriday-GPTs-Prompts) – Black‑Friday‑style GPTs‑prompts.  
- [friuns2/Leaked‑GPTs](https://github.com/friuns2/Leaked-GPTs) – Leaked GPTs‑style prompts.  
- [EmbraceAGI/Awesome‑AI‑GPTs](https://github.com/EmbraceAGI/Awesome-AI-GPTs) – AI‑focused GPTs‑style catalog.  
...
- [trinib/ZORG‑Jailbreak‑Prompt‑Text](https://github.com/trinib/ZORG-Jailbreak-Prompt-Text) – ZORG‑style jailbreak‑prompt text.  
- [iAmAjayTeli/Gemini‑Jailbreak](https://github.com/iAmAjayTeli/Gemini-Jailbreak) – Gemini‑jailbreak‑style prompts.  
- [Rafaelmdcarneiro/system_prompts_leaks](https://github.com/Rafaelmdcarneiro/system_prompts_leaks) – Leaked system‑prompt examples.  
- [YeeKal/leaked‑system‑prompts](https://github.com/YeeKal/leaked-system-prompts) – Another leaked‑system‑prompt collection.  
- [asgeirtj/system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks) – System‑prompt‑leak repository.  
- [baumpi/Leaked‑Ai‑System‑Prompts](https://github.com/baumpi/Leaked-Ai-System-Prompts) – Leaked‑style system‑prompt repo.  
- [reis428/system_prompts_leaks](https://github.com/reis428/system_prompts_leaks) – More leaked‑style examples.  
...
This is a curated list of links. Each linked repository is covered by its own license.  
This README is effectively just a categorized index and should be treated as documentation, not code.
